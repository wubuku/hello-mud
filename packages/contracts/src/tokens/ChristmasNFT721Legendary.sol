...
contract ChristmasNFT721Legendary is ERC721URIStorage, Ownable {
  uint256 public nextTokenId = 1;

  event Minted(address indexed to, uint256 tokenId, string tokenURI);
  //event Airdropped(address[] recipients, string[] tokenURIs);

  constructor(address initialOwner) ERC721("Christmas Special Top 100 Sailors", "CSTS") Ownable(initialOwner) {}
